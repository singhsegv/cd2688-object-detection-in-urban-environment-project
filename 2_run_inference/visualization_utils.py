...
def draw_bounding_box_on_image(image,
  ...
  # instead of above.
#   display_str_heights = [font.getlength(ds)[3] for ds in display_str_list]
  display_str_heights = [(font.getbbox(ds)[3] - font.getbbox(ds)[3]) for ds in display_str_list]
...
#     text_width, text_height = font.getlength(display_str)
